...
<html lang="en">
<head>
<link rel="icon" type="image/jpg" sizes="32x32" href="img/favicon-32x32.jpg">    <!--favicon-->
...
<nav class="navbar navbar-expand-md navbar-light fixed-top">
		...
		<strong><em>Masterchef</em></strong>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navi">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
	                 <a class="nav-link" href="#aboutus">History</a>
	             </li>
	            <li class="nav-item">
                ...
                <li class="nav-item">
                   ...
                   <li class="nav-item">
                        <a class="nav-link" href="#pick">Speciality</a>
                   </li>

                   <li class="nav-item">
                        <a class="nav-link" href="#chef">Our Chefs</a>
                   </li>
